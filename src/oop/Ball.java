...
public class Ball {
    ...
    public Ball(float x, float y, float speedX, float speedY, float radius, Color color, int num) {
    	 this.x = x;
         this.y = y;
         // Convert (speed, angle) to (x, y), with y-axis inverted
         this.speedX = speedX;
    ...
    public static Ball createBallFromDTO(BallDTO balldto) {
    	return new Ball(0, balldto.y, balldto.speedX, balldto.speedY, balldto.radius, balldto.color,0);
    }
